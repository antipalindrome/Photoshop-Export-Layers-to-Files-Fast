...
var DEFAULT_SETTINGS = {
    ...
    useRegex: app.stringIDToTypeID('useRegex'),
    regexPattern: app.stringIDToTypeID('regexPattern'),
    regexReplace: app.stringIDToTypeID('regexReplace'),
};
...
function showDialog() {
    ...
    fields.cbRegex.value = prefs.useRegex;
    fields.txtRegexPattern.enabled = prefs.useRegex;
    fields.txtRegexPattern.text = prefs.regexPattern;
    fields.txtRegexReplace.enabled = prefs.useRegex;
    fields.txtRegexReplace.text = prefs.regexReplace;
    fields.cbRegex.onClick = function() {
        fields.txtRegexPattern.enabled = this.value;
        fields.txtRegexReplace.enabled = this.value;
    }
...
function saveSettings(dialog) {
    ...
    desc.putBoolean(DEFAULT_SETTINGS.useRegex, fields.cbRegex.value);
    desc.putString(DEFAULT_SETTINGS.regexPattern, fields.txtRegexPattern.text);
    desc.putString(DEFAULT_SETTINGS.regexReplace, fields.txtRegexReplace.text);
...
function getSettings(formatOpts) {
    ...
    try {
        ...
        savedSettings = {
            ...
            useRegex: desc.getBoolean(DEFAULT_SETTINGS.useRegex),
            regexPattern: desc.getString(DEFAULT_SETTINGS.regexPattern),
            regexReplace: desc.getString(DEFAULT_SETTINGS.regexReplace),
        };
    } catch (e) {
    }
...
function getDialogFields(dialog) {
    return {
        ...
        cbRegex: dialog.findElement("cbRegex"),
        txtRegexPattern: dialog.findElement("txtRegexPattern"),
        txtRegexReplace: dialog.findElement("txtRegexReplace"),
...
// GRPFILENAMEREGEXWRAPPER
// =======================
var grpFilenameRegexWrapper = pnlNameFiles.add("group", undefined, {name: "grpFilenameRegexWrapper"}); 
    grpFilenameRegexWrapper.orientation = "column"; 
    grpFilenameRegexWrapper.alignChildren = ["left","center"]; 
    grpFilenameRegexWrapper.spacing = 2; 
    grpFilenameRegexWrapper.margins = 0; 

var cbRegex = grpFilenameRegexWrapper.add("checkbox", undefined, undefined, {name: "cbRegex"}); 
    cbRegex.text = "Apply Regex to Layer Name"; 

// GRPFILENAMEREGEXPATTERNWRAPPER
// ==============================
var grpFilenameRegexPatternWrapper = grpFilenameRegexWrapper.add("group", undefined, {name: "grpFilenameRegexPatternWrapper"}); 
    grpFilenameRegexPatternWrapper.orientation = "row"; 
    grpFilenameRegexPatternWrapper.alignChildren = ["left","center"]; 
    grpFilenameRegexPatternWrapper.spacing = 10; 
    grpFilenameRegexPatternWrapper.margins = 0; 

var lblRegexPattern = grpFilenameRegexPatternWrapper.add("statictext", undefined, undefined, {name: "lblRegexPattern"}); 
    lblRegexPattern.text = "Pattern"; 
    lblRegexPattern.preferredSize.width = 50; 

var txtRegexPattern = grpFilenameRegexPatternWrapper.add('edittext {properties: {name: "txtRegexPattern"}}'); 
    txtRegexPattern.preferredSize.width = 215; 

// GRPFILENAMEREGEXREPLACEMENTWRAPPER
// ==================================
var grpFilenameRegexReplacementWrapper = grpFilenameRegexWrapper.add("group", undefined, {name: "grpFilenameRegexReplacementWrapper"}); 
    grpFilenameRegexReplacementWrapper.orientation = "row"; 
    grpFilenameRegexReplacementWrapper.alignChildren = ["left","center"]; 
    grpFilenameRegexReplacementWrapper.spacing = 10; 
    grpFilenameRegexReplacementWrapper.margins = 0; 

var lblRegexReplace = grpFilenameRegexReplacementWrapper.add("statictext", undefined, undefined, {name: "lblRegexReplace"}); 
    lblRegexReplace.text = "Replace"; 
    lblRegexReplace.preferredSize.width = 50; 

var txtRegexReplace = grpFilenameRegexReplacementWrapper.add('edittext {properties: {name: "txtRegexReplace"}}'); 
    txtRegexReplace.preferredSize.width = 215; 
...
var tabpnlExportOptions = pnlExportAs.add("tabbedpanel", undefined, undefined, {name: "tabpnlExportOptions"}); 
    ...
    tabpnlExportOptions.preferredSize.width = 554.594; 
